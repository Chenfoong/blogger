...
<Group description="Blog title" selector="div.widget.Header">
  <Variable name="blog.title.font" description="Font"
      type="font"
      default="$(robotoBold45)"  value="normal bold 45px Roboto, sans-serif"/>
  <Variable name="blog.title.color" description="Color"
      type="color"
      default="#fff"  value="#757575"/>
...
<Group description="Posts" selector="div.widget.Blog">
  <Variable name="posts.title.color" description="Post title color"
      type="color"
      default="#424242"  value="#4285F4"/>
  <Variable name="posts.title.font" description="Post title font"
      type="font"
      default="$(robotoBold22)"  value="normal bold 21px Roboto, sans-serif"/>
  <Variable name="posts.stream.title.font" description="Post title stream font"
      type="font"
      default="$(robotoBold30)"  value="normal bold 20px Roboto, sans-serif"/>
  <Variable name="posts.text.font" description="Post text font"
      type="font"
      default="$(body.text.font)"  value="normal normal 18px Roboto, sans-serif"/>
  ...
  <Variable name="blockquote.color" description="Blockquote color"
      type="color"
      default="#444"  value="#2196f3"/>
  <Variable name="posts.icons.color"
      description="Post icons color"
      type="color"
      default="#707070"  value="#2196f3"/>
...
<!-- End Google Tag Manager (noscript) -->
  ...
  <form expr:action='data:blog.searchUrl'>
    ...
    <nav id="menu-bar" aria-label="Quick Links">
        ...
        <a href="https://www.sun.edu.my/p/cambridge-igcse-syllabus.html" class="nav-link" aria-label="Academics" tabindex="-1">
            <div class="icon-3d-container">
  ...
  .sunrise-logo {
    ...
    font-size: 2.5rem;
    font-weight: 600;
    background: linear-gradient(90deg, #168eff, #5398ff, #8c7bff, #d15bff, #f755ff, #ff6c6c,#ffbb54);
...
<div class="sunrise-header">
  <h1 class="sunrise-logo">
    <a href="/"><span class="emoji">😃</span> Sunrise Education</a>
  <h1>
  <div class="color-line"></div>
</h1></h1></div>]]></b:widget-setting>
                      </b:widget-settings>
                      <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
...
.icon-front { transform: translateZ(24px); }
...
<!-- Top-right toggle button -->
    ...
    <nav id="menu-bar" aria-label="Quick Links">
        ...
        <a href="https://www.sun.edu.my/2024/07/admissions-2025.html" class="nav-link" aria-label="News" tabindex="-1">
            <div class="icon-3d-container">
                <div class="icon-face icon-front" style="background-image: url('https://img.icons8.com/3d-fluency/48/news.png')"></div>
                <div class="icon-face icon-back">NEWS</div>
            </div>
        ...
        <a href="https://www.sun.edu.my/p/contact.html" class="nav-link" aria-label="Contact" tabindex="-1">
            <div class="icon-3d-container">
                <div class="icon-face icon-front" style="background-image: url('https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgSukoMSb4WIhmbBeZp4CQE4I4IAZKxlv8YiYXv0X_JfMdObCslt3c-42y-tV9UJ_vKMmm5BVKbIq_bFtCrgXsNxlg5Y3LQcillD4Fp-sXNeniqORkXjxrXOwU6Sc52MVBeWJW5FaQK8DX2e2GTwT3iNRTPW1wySIS3u9qNJKqawgKuM5pZa0U3BkiW/s640/call-us-1.gif')"></div>
                <div class="icon-face icon-back">CONTACT</div>
            </div>
        </a>
        <a href="https://www.sun.edu.my/p/about-us.html" class="nav-link" aria-label="About" tabindex="-1">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const toggleMenu = () => {
        ...
        menuBar.style.display = isOpen ? 'none' : 'flex';
        navLinks.forEach(link => link.tabIndex = isOpen ? -1 : 0);
        if (!isOpen) setTimeout(() => navLinks[0].focus(), 100);
    };

    iconContainers.forEach(icon => {
        const x = (Math.random() * 10) - 5;
        const y = (Math.random() * 10) - 5;
        icon.style.transform = `rotateX(${x}deg) rotateY(${y}deg)`;
  ...
  <div class='widget-content'>
    <data:content/>
                    ...
                    <b:widget id='HTML19' locked='false' title='' type='HTML' visible='false'>
                      <b:widget-settings>
                        <b:widget-setting name='content'><![CDATA[<style>
  .sunrise-header {
    text-align: center;
  ...
  .sunrise-logo {
    ...
    color: transparent;
    animation: gradient 8s ease infinite;
    text-shadow: none; /* Removed text shadow for better transparency */
    letter-spacing: -0.3px;
    margin: 0;
    line-height: 1.2;
    cursor: pointer;
  ...
  .sunrise-logo:hover {
    transform: scale(1.02);
    /* Removed solid color change on hover to maintain transparency */
  }
...
<div class="sunrise-header">
  ...
  <div class='widget-content'>
    <data:content/>
                    ...
                    <b:widget id='Header1' locked='true' title='😀 Sunrise Education (Header)' type='Header' visible='false'>
                      <b:widget-settings>
                        <b:widget-setting name='displayUrl'/>
                        <b:widget-setting name='displayHeight'>0</b:widget-setting>
                        <b:widget-setting name='sectionWidth'>666</b:widget-setting>
          ...
          <div>
            ...
            <b:include name='super.title'/>
                    ...
                    <b:widget id='HTML18' locked='false' title='' type='HTML' visible='false'>
                      <b:widget-settings>
                        <b:widget-setting name='content'><![CDATA[<!-- Blogger Header -->
<header class="blogger-header">
  <div class="header-container">
    <a href="https://www.sun.edu.my" class="header-logo">😀 <span>Sunrise Education</span></a>
  </div>
</header>
...
<style>
  ...
  <!-- Tagline -->
  <p class="tagline">😘 Happiness Learning Growth</p>
  
  <!-- Header -->
  <header class="site-header">
    <a href="https://www.sun.edu.my">😀 Sunrise Education</a>
  </header>
  ...
  <nav id="menu-bar" role="navigation">
    <a href="https://www.sun.edu.my" class="nav-link active">
      <span aria-hidden="true">🏠</span> Home
    </a>
    <a href="https://www.sun.edu.my/2024/07/admissions-2025.html" class="nav-link">
      <span aria-hidden="true">📰</span> News
    </a>
    <a href="https://www.sun.edu.my/p/cambridge-igcse-syllabus.html" class="nav-link">
      <span aria-hidden="true">📚</span> Academics
    </a>
    <a href="https://www.sun.edu.my/p/branch.html" class="nav-link">
      <span aria-hidden="true">📍</span> Campuses
    </a>
    <a href="https://www.sun.edu.my/p/contact.html" class="nav-link">
      <span aria-hidden="true">📞</span> Contact
    </a>
    <a href="https://www.sun.edu.my/p/about-us.html" class="nav-link">
  ...
  <script>
    function toggleMenu() {
      const menuBar = document.getElementById('menu-bar');
      const toggleButton = document.getElementById('home-icon');
      const isExpanded = toggleButton.getAttribute('aria-expanded') === 'true';
      
      menuBar.style.display = isExpanded ? 'none' : 'flex';
    ...
    document.addEventListener('click', (event) => {
      const menuBar = document.getElementById('menu-bar');
      const toggleButton = document.getElementById('home-icon');
      const isMenuVisible = menuBar.style.display === 'flex';
  
      if (isMenuVisible && !menuBar.contains(event.target) && !toggleButton.contains(event.target)) {
        menuBar.style.display = 'none';
  ...
  :root {
    ...
    --hover-color: rgba(150, 29, 29, 0.5);
    --text-light: #ffffff;
  }
  body {
  ...
  /* Dock menu positioned top-right, vertical direction */
  #menu-bar {
    display: none;
    position: fixed;
    top: 60px;
...
<!-- Dock menu slides vertically from top-right -->
<nav id="menu-bar" role="navigation">
  <a href="https://www.sun.edu.my" class="nav-link" aria-label="Home"><span>🏠</span></a>
  <a href="https://www.sun.edu.my/2024/07/admissions-2025.html" class="nav-link" aria-label="News"><span>📰</span></a>
  <a href="https://www.sun.edu.my/p/cambridge-igcse-syllabus.html" class="nav-link" aria-label="Academics"><span>📚</span></a>
  <a href="https://www.sun.edu.my/p/branch.html" class="nav-link" aria-label="Campuses"><span>📍</span></a>
  <a href="https://www.sun.edu.my/p/contact.html" class="nav-link" aria-label="Contact"><span>📞</span></a>
  <a href="https://www.sun.edu.my/p/about-us.html" class="nav-link" aria-label="About"><span>ℹ️</span></a>
</nav>
...
<script>
  ...
  document.addEventListener('click', (event) => {
    const menuBar = document.getElementById('menu-bar');
    const toggleButton = document.getElementById('home-icon');
    if (!menuBar.contains(event.target) && !toggleButton.contains(event.target)) {
      menuBar.style.display = 'none';
      toggleButton.setAttribute('aria-expanded', 'false');
    }
  });
    ...
    <data:content/>
                  ...
                  <nav role='navigation'>
                    <b:section class='clearboth' id='page_list_top' name='Page List (Top)' showaddelement='false'>
                      <b:widget cond='!data:view.isPost' id='PageList1' locked='true' title='Menu' type='PageList' visible='false'>
                        <b:widget-settings>
                          <b:widget-setting name='pageListJson'><![CDATA[{"link1":{"href":"http://www.sun.edu.my/p/blog-page_20.html","position":1,"title":"🎨 课外活动"},"link0":{"href":"http://www.sun.edu.my/p/curriculum-activities.html","position":0,"title":"🎨 Curriculum Activities"},"link5":{"href":"http://www.sun.edu.my/p/cambridge-igcse-syllabus.html","position":5,"title":"📖 Cambridge IGCSE Syllabus"},"link4":{"href":"http://www.sun.edu.my/p/sunrise-school.html","position":4,"title":"🌞 Sunrise School"},"link3":{"href":"http://www.sun.edu.my/p/about-us.html","position":3,"title":"🌈 About Sunrise"},"link2":{"href":"http://www.sun.edu.my/p/blog-page_18.html","position":2,"title":"🏃 申请入学-5-步骤"},"link8":{"href":"https://www.sun.edu.my/p/contact.html","position":8,"title":"Contacts us"},"link7":{"href":"http://www.sun.edu.my/p/happiness-learning-growth.html","position":7,"title":"😘 Happiness Learning Growth"},"link6":{"href":"http://www.sun.edu.my/p/blog-page.html","position":6,"title":"😀 快乐学习成长"}}]]></b:widget-setting>
            ...
            <b:include name='super.defaultAdUnit'/>
              ...
              <main class='centered-bottom' id='main' role='main' tabindex='-1'>
                ...
                <b:section class='main' id='page_body' name='Page Body' showaddelement='false'>
                  <b:widget cond='data:view.isHomepage' id='FeaturedPost1' locked='true' title='Post' type='FeaturedPost' version='2' visible='true'>
                    <b:widget-settings>
        ...
        <b:include name='snippetedPostContent'/>
                  ...
                  <b:widget id='Blog1' locked='true' title='Blog Posts' type='Blog' version='2' visible='true'>
                    <b:widget-settings>
                      ...
                      <b:widget-setting name='authorLabel'>By Sunrise School</b:widget-setting>
 ...
 &quot;publisher&quot;: {
    ...
    <b:if cond='data:showCmtPopup'>
      <div id='comment-popup'>
        <iframe allowtransparency='allowtransparency' frameborder='0' id='comment-actions' name='comment-actions' scrolling='no'>
                  ...
                  <b:widget id='HTML1' locked='false' title='🤙 Contact' type='HTML' visible='true'>
                    <b:widget-settings>
                      <b:widget-setting name='content'><![CDATA[<!doctype html>
  ...
  <div class="contact-info">
    <p>💁 <strong>Contact Office 🏢</strong>: +6 012-425 1556</p>
    <button onclick="window.location.href='tel:+6012-425-1556';">📞 Call Us</button>
    <button onclick="window.location.href='https://wa.link/vm8vm6';">📲 WhatsApp Us</button>

    <p>📧 <strong>Email:</strong> <a href="mailto:LOVE@sun.edu.my">LOVE@sun.edu.my</a><button onclick="window.location.href='mailto:LOVE@sun.edu.my';">📧 Email Us</button>

    <p>🌐 <a href="https://www.sun.edu.my/" target="_blank">Visit our Website: www.sun.edu.my</a></p></p></div>

  <details>
    <summary>🏫 Klang Botanik</summary>
    <div class="contact">
      <p><strong>KENT:</strong> 012-285 6060<br/>
      <a href="http://wa.link/kt4zyr" target="_blank">📱 WhatsApp Kent</a></p>

      <p><strong>CARMEN:</strong> 012-345 9770<br/>
      <p><a href="http://wa.link/s3t2tc" target="_blank">📱 WhatsApp Carmen</a></p>
    </p></div>
    <p>🅵 <a href="https://www.facebook.com/SunriseResourceCentre" target="_blank">Like us on Facebook</a></p>
    <p>🏡 Address: No. 25-2nd Floor, Jalan Mahogani 5/Ks7, 41200 Klang, Selangor, Malaysia</p>
    <iframe loading="lazy" referrerpolicy="no-referrer-when-downgrade"
      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.3639475211826!2d101.4428172756845!3d2.9962839540718544!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cdad70b2f7fbb1%3A0xf10e7e39eaaac017!2zU3VucmlzZSBJbnRlcm5hdGlvbmFsIEVkdWNhdGlvbiBJR0NTRSBMZWFybmluZyBDZW50cmUg6Ziz5YWJ5Zu96ZmF5a2m5bqc5Lit5b-D!5e0!3m2!1sen!2smy!4v1704781545624!5m2!1sen!2smy">
    </iframe>
  </details>

  <details>
    <summary>🏫 Rawang</summary>
    <div class="contact">
      <p><strong>Ms. Yuva:</strong> 016-6212504<br/>
      <a href="https://wa.me/+60166212504" target="_blank">📱 WhatsApp Yuva</a></p>

      <p><strong>CARMEN:</strong> 012-425 1556<br/>
      <a href="http://wa.link/s3t2tc" target="_blank">📱 WhatsApp Carmen</a></p>
    </div>
    <p>🅵 <a href="https://www.facebook.com/SunriseRawang" target="_blank">Like us on Facebook</a></p>
    <p>🏡 Address: No. 32-2nd Floor, Jalan Bandar Rawang 12, Pusat Bandar Rawang, 48000 Rawang, Selangor, Malaysia</p>
    <iframe loading="lazy" referrerpolicy="no-referrer-when-downgrade"
      src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15932.494311738115!2d101.5767832!3d3.3196229!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc4399f5d7c8ab%3A0x19c0cbc686ae55c1!2sSunrise%20Education%20Rawang!5e0!3m2!1sen!2smy!4v1704782843864!5m2!1sen!2smy">
    </iframe>
  </details>
  ...
  <div class='widget-content'>
    <data:content/>
                  ...
                  <b:widget cond='data:view.isSingleItem and data:posts any (p =&gt; p.id != data:view.postId)' id='PopularPosts1' locked='true' title='More' type='PopularPosts' version='2' visible='true'>
                    <b:widget-settings>
...
<style>
  h2 {
    ...
    background: linear-gradient(to right, #f51b1b, #ff3cac, #784ba0, #2b86c5, #00c9ff, #92fe9d, #edde07, #ff03ff);
    -webkit-background-clip: text;
    ...
    position: relative;
        ...
        /* New Promotion Badge - matching days-badge style */
        .promo-badge {
            display: inline-block;
            background: linear-gradient(135deg, #ff3e9d 0%, #ff8a00 100%);
            color: white;
            font-size: 1.2rem;
            font-weight: bold;
            padding: 15px 30px;
...
<div class="popup-overlay" id="popup" aria-hidden="true" aria-labelledby="popupHeading">
  <div class="popup-box" role="dialog" aria-modal="true">
    ...
    <h2 id="popupHeading">
      2025 School Holiday Programme</h2>
                <div class="promo-badge slide-up">
                 <span>😋Yummy Lunch<br />+<br />Free Gift🎁!</span>
                </div>

                <div class="days-badge">
                    <span>2 Days of Fun!</span>
                </div>
    <img class="popup-image" 
 alt="2025 School Holiday Programme banner" 
 src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjBKJ3VIdOCXRwlxWh9V_wRx5g77NZ3GXWN0ijPYHwDuTLEhB-QCRuomUBsEUlEgdXbkr7qMhAUJFE1WoPjphMTPXZj-L_u_FKiKhHxoHavN17hl7r4yxeE10EtZ5MVc0yuQwfceNRMnooicbgv0fzP0fXNqmAFEtTpPCbdAp-skTVJdqVeXHtkuJbc/s600/SHP%20%281%29-1z-04-04-04.png" 
 loading="lazy" />
    <a class="link-button" 
       href="http://www.sun.edu.my/2025/05/2025-school-holiday-programme.html" 
       target="_blank"
       rel="noopener noreferrer">
      Click here to read more
    </a>
    <div class="popup-footer">
      <p style="margin: 0;">Closing in <span id="countdown">20</span> seconds</p>
...
<script>
  ...
  function startCountdown() {
    countdown = setInterval(() => {
      secondsLeft--;
      document.getElementById('countdown').textContent = secondsLeft;
      if(secondsLeft <= 0) hidePopup();
    }, 1000);

    timeoutId = setTimeout(hidePopup, 20000);
  }
...
<div class="popup-overlay" id="popup" aria-hidden="true" aria-labelledby="popupHeading">
  <div class="popup-box" role="dialog" aria-modal="true">
    <button class="popup-close" onclick="hidePopup()" aria-label="Close popup">&times;</button>
    <h2 id="popupHeading">
      2025 School Holiday Programme
      <span class="days-badge">2 Days</span>
    </h2>
    <img class="popup-image" 
 alt="2025 School Holiday Programme banner" 
 src="https://matahari.sun.edu.my/SHP%20(1)-1z-04-04-04.png" 
 loading="lazy" />
    <a class="link-button" 
       href="http://www.sun.edu.my/2025/05/2025-school-holiday-programme.html" 
       target="_blank"
    ...
    <div class="popup-footer">
      <p style="margin: 0;">Closing in <span id="countdown">18</span> seconds</p>
...
</script></!doctype>]]></b:widget-setting>
                    </b:widget-settings>
                    <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
                  ...
                  <b:widget id='HTML22' locked='false' title='pop-up advertiment' type='HTML' visible='false'>
                    <b:widget-settings>
                      <b:widget-setting name='content'><![CDATA[<!doctype html>
<style>
  h2 {
...
<div class="popup-overlay" id="popup" aria-hidden="true" aria-labelledby="popupHeading">
  <div class="popup-box" role="dialog" aria-modal="true">
    ...
    <h2 id="popupHeading">
      2025 School Holiday Programme</h2>
<span class="days-badge">2 Days of Fun!</span>
    <img class="popup-image" 
 alt="2025 School Holiday Programme banner" 
 src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjBKJ3VIdOCXRwlxWh9V_wRx5g77NZ3GXWN0ijPYHwDuTLEhB-QCRuomUBsEUlEgdXbkr7qMhAUJFE1WoPjphMTPXZj-L_u_FKiKhHxoHavN17hl7r4yxeE10EtZ5MVc0yuQwfceNRMnooicbgv0fzP0fXNqmAFEtTpPCbdAp-skTVJdqVeXHtkuJbc/s600/SHP%20%281%29-1z-04-04-04.png" 
 loading="lazy" />
...
<script>
  ...
  <div class='widget-content'>
    <data:content/>
                  ...
                  <b:widget id='HTML21' locked='false' title='pop-up' type='HTML' visible='false'>
                    <b:widget-settings>
                      <b:widget-setting name='content'><![CDATA[<!doctype html>
...
<div class="popup-overlay" id="popup">
  <div class="popup-box">
    ...
    <h2>👋🏻 Hi there! Welcome to SUNRISE</h2>
    <div style="clear: both; text-align: center;">
      <img alt="" border="0" width="95%" src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi9HaazFhSpbh8pVyW-t1_9cNXvpMABjUUFZDiM1i96N2pe2r9l8dcp9JlqYABj8GbTwnFxO76HS5-4OhyVZ_bR0mx-8EgnXU3w7nC8VCuoYOZZRz1xbDwqKWn-xnRz85NznlZAFsNu7GSJof71ytPYBH2tlvM1I4k0_X2k3zLr3H9ktKrk1dZ_XOY1/s1627/4-ENG-3-01.jpg"/>
    </div>
    <a class="link-button" href="https://www.sun.edu.my/2024/07/admissions-2025.html" target="_blank">
      Click here to read more
    </a>
...
<script>
  ...
  function startCountdown() {
    ...
    timeoutId = setTimeout(hidePopup, 18000);
  }
  ...
  <div class='widget-content'>
    <data:content/>
                  ...
                  <b:widget id='HTML23' locked='false' title='' type='HTML' visible='false'>
                    <b:widget-settings>
                      <b:widget-setting name='content'><![CDATA[<!doctype html>
<style>
  /* Optimized CSS with reduced animations and better performance */
  h2 {
    text-align: center;
    font-size: clamp(18px, 4vw, 24px);
    font-weight: 800;
    background: linear-gradient(to right, #f51b1b, #ff3cac, #784ba0, #2b86c5, #00c9ff, #92fe9d);
    -webkit-background-clip: text;
    -webkit-text-fill-color: transparent;
    margin: 20px 0;
    line-height: 1.4;
...
<div class="popup-overlay" id="popup" aria-hidden="true">
  <div class="popup-box" role="dialog" aria-modal="true">
    <button class="popup-close" onclick="hidePopup()" aria-label="Close popup">&times;</button>
    <h2>2025 School Holiday Programme</h2>
    
    <div class="promo-badge">😋Yummy Lunch + Free Gift🎁!</div>
    <div class="days-badge">2 Days of Fun!</div>
    
    <div class="image-container">
      <div class="cloud" style="width:80px; height:50px; top:10%; left:5%; animation-duration:25s;"></div>
      <div class="cloud" style="width:120px; height:70px; top:25%; right:5%; animation-duration:30s;"></div>
      <img src="https://matahari.sun.edu.my/SHP%20(1)-1z-04-04-04.png" 
 alt="2025 School Holiday Programme" 
 class="popup-image" 
 loading="lazy" />
    </div>
    ...
    <div class="popup-footer">
      <p>Closing in <span id="countdown">18</span> seconds</p>
      <button class="close-button" onclick="hidePopup()">Close</button>
    </div>
  </div>
</div>
...
<script>
  ...
  (function() {
    ...
    function showPopup() {
      ...
      closeTimer = setTimeout(hidePopup, secondsLeft * 1000);
    }
    ...
    window.addEventListener('resize', debounce(function() {
      if (window.innerWidth < 768 && popup.classList.contains('show')) {
        hidePopup();
      }
    }, 200));
  })();
    ...
    <data:content/>
            ...
            <b:section class='footer' id='footer' name='Footer' showaddelement='false' tag='footer'>
              <b:widget id='Attribution1' locked='true' title='' type='Attribution' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='copyright'>&#10084;&#65039; Sunrise School &#10084;&#65039;</b:widget-setting>
                </b:widget-settings>
                <b:includable id='main' var='this'>
  <div class='widget-content'>
    <div class='blogger'>
  ...
  <b:include name='reportAbuse'/>
              ...
              <b:widget id='HTML17' locked='false' title='' type='HTML' visible='true'>
                <b:widget-settings>
                  <b:widget-setting name='content'><![CDATA[<!doctype html>
  Happiness Learning & Growth | Sunrise Education
  <style>
  ...
  <script>
    ...
    // Show the button when scrolled down more than 20px
  ...
  <div class='widget-content'>
    <data:content/>
              ...
              <b:widget id='HTML24' locked='false' title='🌗 Toggle Mode' type='HTML' visible='false'>
                <b:widget-settings>
                  <b:widget-setting name='content'><![CDATA[<!doctype html>
    ...
    <aside class='sidebar-container container sidebar-invisible' role='complementary'>
      ...
      <div class='sidebar_top_wrapper'>
        ...
        <b:section class='sidebar_top' id='sidebar_top' name='Sidebar (Top)'>
          <b:widget id='ContactForm1' locked='false' title='Contact Form' type='ContactForm' visible='false'>
            <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
</b:includable>
    ...
    <div class='form'>
      <form name='contact-form'>
        ...
        <div style='text-align: center; max-width: 222px; width: 100%'>
          ...
          <b:widget id='Profile1' locked='true' title='Sunrise School' type='Profile' visible='false'>
            <b:widget-settings>
  ...
  <script src='//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit'/>
        ...
        <b:widget id='BlogSearch3' locked='false' title='Search' type='BlogSearch' visible='false'>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
</b:includable>
  ...
  <form expr:action='data:blog.searchUrl'>
    ...
    <form class="search-box" onsubmit="searchSUN(event)">
      <input type="text" id="searchInput" placeholder="Search SUNRISE" />
      <button type="submit">🔍</button>
    </form>

    <script>
      function searchSUN(event) {
        event.preventDefault(); // prevent page reload on form submission
        const query = document.getElementById('searchInput').value.trim();
        if (query) {
          const site = "www.sun.edu.my";
  ...
  <details id="A">
    <summary>❤️ Love</summary>
    <a href="https://www.sun.edu.my">🏠 Home</a>
    <a href="https://www.sun.edu.my/p/blog-page.html">😀 快乐学习成长</a>
    <a href="https://www.sun.edu.my/p/blog-page_73.html">🌱 我们的使命 🌱</a>
    <a href="https://www.sun.edu.my/p/our-responsibility.html">🌟 我们的多项重要责任</a>
    <a href="https://www.sun.edu.my/p/happiness-learning-growth.html">😘 Happiness Learning Growth</a>
    <a href="https://www.sun.edu.my/p/sunrise-homeschooling.html">🌞 Sunrise Homeschooling</a>
    <a href="https://www.sun.edu.my/p/our-missions.html">🌱 Our Missions 🌱</a>
    <a href="http://www.sun.edu.my/p/our-responsibility_2.html">🌟 Our responsibilities</a>
  </details>

  <details id="B">
    <summary>📚 Academic</summary>
    <a href="https://www.sun.edu.my/p/igcse.html">📖 IGCSE 英国剑桥课程</a>
    <a href="https://www.sun.edu.my/p/blog-page_20.html">🎨 课外活动</a>
    <a href="https://www.sun.edu.my/p/cambridge-igcse-syllabus.html">📖 Cambridge IGCSE Syllabus</a>
    <a href="https://www.sun.edu.my/p/curriculum-activities.html">🎨 Curriculum Activities</a>
    <a href="http://www.sun.edu.my/p/sunrise-planner.html">📅 Calendar</a>
  </details>

  <details id="C">
    <summary>🏃 Admissions</summary>
    <a href="https://www.sun.edu.my/p/blog-page_18.html">🏃 申请入学-5-步骤</a>
    <a href="https://www.sun.edu.my/p/admissions.html">🏃 Enrollment -5- Steps</a>
    <a href="https://www.sun.edu.my/2023/12/admissions.html">🛩️ Admissions</a>
    <a href="https://www.sun.edu.my/p/contact.html">🤙 Contact</a>
    <a href="https://www.sun.edu.my/p/branch.html">🏡 Campuses 🏡</a>
  </details>

  <details id="D">
    <summary>🌟 Vision</summary>
    <a href="https://www.sun.edu.my/p/blog-page_19.html">💪 策略与发展蓝图</a>
    <a href="https://www.sun.edu.my/p/development-vision.html">💪 Development Vision</a>
    <a href="https://www.sun.edu.my/2024/06/were-hiring_13.html">📢 We're Hiring</a>
    <a href="https://www.sun.edu.my/p/student-and-teacher-handbook.html">📘 Handbook</a>
  </details>

  <details id="E">
    <summary>🌍 About us</summary>
    <a href="https://www.facebook.com/SunriseResourceCentre">🅵 Facebook</a>
    <a href="https://www.sun.edu.my/p/principals-message.html">✨ Principal's Message</a>
    <a href="https://www.sun.edu.my/p/professors-message.html">✨ Chairman's Message</a>
    <a href="https://www.sun.edu.my/p/founders-message.html">✨ Founder's Message</a>
    <a href="https://www.sun.edu.my/p/about-us.html">🌈 About Sunrise</a>
  </details>

  <script>
    // Remember and restore last opened section
    document.addEventListener('DOMContentLoaded', function() {
        const sections = document.querySelectorAll("details");
        const lastOpenId = localStorage.getItem("lastOpen");
        
        // Close all sections except the last opened one
        sections.forEach(section => {
            section.addEventListener('toggle', function() {
                if (this.open) {
                    localStorage.setItem("lastOpen", this.id);
            ...
            // Open the last opened section
            if (section.id === lastOpenId) {
                section.open = true;
            }
        });
    });
  ...
  <div class='widget-content'>
    <data:content/>
        ...
        <b:widget id='HTML16' locked='false' title='Search World' type='HTML' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<!-- Google Custom Search Engine for Blogger -->
<div class="gcse-searchbox-only"></div>
<script async="async" src="https://cse.google.com/cse.js?cx=75b10891b8e114a75"></script>]]></b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
        ...
        <b:widget id='BlogSearch2' locked='false' title='🔍 Search SUNRISE 🌍' type='BlogSearch' visible='false'>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  <b:include name='content'/>
</b:includable>
  ...
  <form expr:action='data:blog.searchUrl'>
    ...
    <b:include name='searchSubmit'/>
        ...
        <b:widget id='HTML13' locked='false' title='' type='HTML' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<!doctype html>
  ...
  <details id="D">
    ...
    <a href="https://www.sun.edu.my/p/development-vision.html">💪 Development Vision</a>
    <a href="https://www.sun.edu.my/2024/06/were-hiring_13.html">📢 We're Hiring</a>
    <a href="https://www.sun.edu.my/p/student-and-teacher-handbook.html">📘 Students and Teachers Handbook</a>
  </details>
...
<script>
  ...
  detailsElements.forEach((details, index) => {
    ...
    if (menuState[key]) details.setAttribute("open", "open");

    details.addEventListener("toggle", () => {
      menuState[key] = details.open;
  ...
  <div class='widget-content'>
    ...
    <style>
        ...
        /* Icon styles */
        #A summary::before { background-image: url('heart-icon.png'); } /* Replace with your icon path */
        #B summary::before { background-image: url('book-icon.png'); }
        #C summary::before { background-image: url('running-icon.png'); }
        #D summary::before { background-image: url('star-icon.png'); }
        #E summary::before { background-image: url('globe-icon.png'); }

        /* Replace the placeholder icon paths with actual paths to your icon files. */
        /* Make sure the icons are in a format supported by browsers (e.g., PNG, SVG). */
    </style>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            // Re-open the last opened section, if any
            if (lastOpen) {
                const openSection = document.getElementById(lastOpen);
                if (openSection) {
                    openSection.setAttribute("open", "");
                }
            }

            // Event listener to save last opened section
            sections.forEach(section => {
                section.addEventListener("toggle", () => {
                    if (section.open) {
                        localStorage.setItem("lastOpen", section.id);
                        //close all others.
  ...
  <div class='widget-content'>
    <data:content/>
        ...
        <b:widget id='PageList2' locked='false' title='❤️ Love' type='PageList' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='pageListJson'><![CDATA[{"link1":{"href":"https://www.sun.edu.my/p/blog-page.html","position":1,"title":"😀 快乐学习成长"},"link0":{"href":"https://www.sun.edu.my","position":0,"title":"🏠 Home"},"link5":{"href":"https://www.sun.edu.my/p/sunrise-homeschooling.html","position":5,"title":"🌞 Sunrise Homeschooling"},"link4":{"href":"https://www.sun.edu.my/p/happiness-learning-growth.html","position":4,"title":"😘 Happiness Learning Growth"},"link3":{"href":"https://www.sun.edu.my/p/our-responsibility.html","position":3,"title":"🌟 我们的多项重要责任 🌟"},"link2":{"href":"https://www.sun.edu.my/p/blog-page_73.html","position":2,"title":"🌱 我们的使命 🌱"},"link7":{"href":"http://www.sun.edu.my/p/our-responsibility_2.html","position":7,"title":"🌟 Our responsibilities"},"link6":{"href":"https://www.sun.edu.my/p/our-missions.html","position":6,"title":"🌱 Our Missions 🌱"}}]]></b:widget-setting>
            <b:widget-setting name='homeTitle'>Home</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  ...
  <ul>
    ...
    <b:loop values='data:links' var='link'>
      <b:include name='pageLink'/>
        ...
        <b:widget id='PageList8' locked='false' title='📚 Academic' type='PageList' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='pageListJson'><![CDATA[{"link1":{"href":"https://www.sun.edu.my/p/blog-page_20.html","position":1,"title":"🎨 课外活动"},"link0":{"href":"https://www.sun.edu.my/p/igcse.html","position":0,"title":"📖 IGCSE 英国剑桥课程"},"8717663297332709708":{"href":"http://www.sun.edu.my/p/sunrise-planner.html","position":4,"title":"Sunrise Calendar"},"link3":{"href":"https://www.sun.edu.my/p/curriculum-activities.html","position":3,"title":"🎨 Curriculum Activities"},"link2":{"href":"https://www.sun.edu.my/p/cambridge-igcse-syllabus.html","position":2,"title":"📖 Cambridge IGCSE Syllabus"}}]]></b:widget-setting>
            <b:widget-setting name='homeTitle'>Home</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  ...
  <ul>
    ...
    <b:loop values='data:links' var='link'>
      <b:include name='pageLink'/>
        ...
        <b:widget id='PageList3' locked='false' title='🏃 Admissions' type='PageList' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='pageListJson'><![CDATA[{"link1":{"href":"https://www.sun.edu.my/p/admissions.html","position":1,"title":"🏃 Enrollment -5- Steps"},"link0":{"href":"https://www.sun.edu.my/p/blog-page_18.html","position":0,"title":"🏃 申请入学-5-步骤"},"link4":{"href":"https://www.sun.edu.my/p/branch.html","position":4,"title":" 🏡 Campuses 🏡"},"link3":{"href":"https://www.sun.edu.my/p/contact.html","position":3,"title":"🤙 Contact"},"link2":{"href":"https://www.sun.edu.my/2023/12/admissions.html","position":2,"title":"🛩️ Admissions"}}]]></b:widget-setting>
            <b:widget-setting name='homeTitle'>Home</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  ...
  <ul>
    ...
    <b:loop values='data:links' var='link'>
      <b:include name='pageLink'/>
        ...
        <b:widget id='PageList4' locked='false' title='🌟 Vision' type='PageList' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='pageListJson'><![CDATA[{"link1":{"href":"https://www.sun.edu.my/p/development-vision.html","position":1,"title":"💪 Development Vision"},"link0":{"href":"https://www.sun.edu.my/p/blog-page_19.html","position":0,"title":"💪 策略与发展蓝图"},"link3":{"href":"https://www.sun.edu.my/p/student-and-teacher-handbook.html","position":3,"title":"📘 Students and Teachers Handbook"},"link2":{"href":"https://www.sun.edu.my/2024/06/were-hiring_13.html","position":2,"title":"📢 We're Hiring"}}]]></b:widget-setting>
            <b:widget-setting name='homeTitle'>Home</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  ...
  <ul>
    ...
    <b:loop values='data:links' var='link'>
      <b:include name='pageLink'/>
        ...
        <b:widget id='PageList5' locked='false' title='🌍 About us' type='PageList' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='pageListJson'><![CDATA[{"link1":{"href":"https://www.sun.edu.my/p/principals-message.html","position":1,"title":"✨ Principal's Message ✨"},"link0":{"href":"https://www.facebook.com/SunriseResourceCentre","position":0,"title":"🅵 Facebook"},"link4":{"href":"https://www.sun.edu.my/p/about-us.html","position":4,"title":"🌈 About Sunrise"},"link3":{"href":"https://www.sun.edu.my/p/founders-message.html","position":3,"title":"✨ Founder's Message ✨"},"link2":{"href":"https://www.sun.edu.my/p/professors-message.html","position":2,"title":"✨ Chairman's Message ✨"}}]]></b:widget-setting>
            <b:widget-setting name='homeTitle'>Home</b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  ...
  <ul>
    ...
    <b:loop values='data:links' var='link'>
      <b:include name='pageLink'/>
        ...
        <b:widget id='Text2' locked='false' title='📞 Contacts' type='Text' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<style>
        button {
            background-color: #6bd1ba;
            color: white;
            border: none;
            padding: 10px 15px;
            cursor: pointer;
    ...
    <div class="contact-info">
        ...
        <p>🏢 <b>Office:</b> +6 012-425 1556<button class=  button onclick="window.location.href='tel:+6012-425 1556'">📞 Call Us</button></p>
        <p>
            <button onclick="window.location.href='https://wa.link/vm8vm6';">📲 Whatsapp us
        </button></p>
       <p>📧 <b>Email:</b> <a href="mailto:LOVE@sun.edu.my">LOVE@sun.edu.my</a><button onclick="window.location.href='mailto:LOVE@sun.edu.my';">📧 Email us</button></p>
    </div>
...
<p>🏡 Campuses 🏡</p>
    ...
    <details off="">
        <summary>Klang Botanik</summary>
        <b>Office:</b> 012-425 1556<br />
            <a href="https://wa.link/vm8vm6" target="_blank">Click to Whatsapp</a>
        
        <p><b>CARMEN:</b> 012-3459770<br />
            <a href="http://wa.link/s3t2tc" target="_blank">Click to Whatsapp</a>
        </p>
        <p>🅵 <a href="https://www.facebook.com/SunriseResourceCentre"target="_blank">Like us on Facebook</a></p>
        <p>🏡 No. 25-2nd Floor, Jalan Mahogani 5/Ks7, 41200 Klang, Selangor, Malaysia</p>
        <iframe loading="lazy" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3984.3639475211826!2d101.4428172756845!3d2.9962839540718544!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cdad70b2f7fbb1%3A0xf10e7e39eaaac017!2zU3VucmlzZSBJbnRlcm5hdGlvbmFsIEVkdWNhdGlvbiBJR0NTRSBMZWFybmluZyBDZW50cmUg6Ziz5YWJ5Zu96ZmF5a2m5bqc5Lit5b-D!5e0!3m2!1sen!2smy!4v1704781545624!5m2!1sen!2smy"></iframe>
    </details>

    <details off="">
        <summary>Rawang</summary>
        <p><b>Ms.Yuva:</b> 016-6212504<br />
            <a href="https://wa.me/+60166212504" target="_blank">Click to Whatsapp</a>
        </p>
        <p><b>CARMEN:</b> 012-425 1556<br />
            <a href="http://wa.link/s3t2tc" target="_blank">Click to Whatsapp</a>
        </p>
        <p>🅵 <a href="https://www.facebook.com/SunriseRawang" target="_blank">Like us on Facebook</a></p>
        <p>🏡 No. 32-2nd Floor, Jalan Bandar Rawang 12, Pusat Bandar Rawang, 48000 Rawang, Selangor, Malaysia</p>
        <iframe loading="lazy" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15932.494311738115!2d101.5767832!3d3.3196229!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31cc4399f5d7c8ab%3A0x19c0cbc686ae55c1!2sSunrise%20Education%20Rawang!5e0!3m2!1sen!2smy!4v1704782843864!5m2!1sen!2smy"></iframe>
    </details>]]></b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
        ...
        <b:widget id='Text1' locked='false' title='Sunrise School International Education' type='Text' visible='true'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<footer>
    <p>&copy; 2025 😀 | All Rights Reserved</p>
</footer>]]></b:widget-setting>
          </b:widget-settings>
          <b:includable id='main'>
  <b:include name='widget-title'/>
  <div class='widget-content'>
    <data:content/>
        ...
        <b:widget id='HTML10' locked='false' title='Menu' type='HTML' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<!doctype html>
    ...
    <div class="menu-bar">
        <button onclick="closeAllDetails()">See All</button>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('details').forEach(details => {
                ...
                if (savedState && savedState[details.id] !== undefined) {
                    details.open = savedState[details.id];
                }
            });
        });
        ...
        function updateMenuState() {
            ...
            const menuState = {};
            document.querySelectorAll('details').forEach(details => {
                menuState[details.id] = details.open;
            });
            localStorage.setItem('menuState', JSON.stringify(menuState));
        }
        ...
        function closeAllDetails() {
            ...
            // Update storage state after closing all
            updateMenuState();
        }
    </script>
  ...
  <div class='widget-content'>
    <data:content/>
        ...
        <b:widget id='HTML12' locked='false' title='Menu' type='HTML' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<!doctype html>
          ...
          <ul>
            ...
            <li>
              <details>
                ...
                <ul>
                  <li><a href="#editor">✏️ Editor</a></li>
...
<script>
  ...
  // Restore opened path
  const lastOpenPath = localStorage.getItem('openDetailsPath');
  if (lastOpenPath) {
    const path = lastOpenPath.split('>');
    let current = document.querySelector('nav');
    path.forEach((index) => {
      const detail = current.querySelectorAll('details')[parseInt(index)];
      if (detail) {
  ...
  // Save open details path
  detailsElements.forEach((detail) => {
    const summary = detail.querySelector('summary');
    summary?.addEventListener('click', () => {
      setTimeout(() => {
        const openPath = [];
        let current = summary.parentElement;
        while (current && current !== document.body) {
          if (current.tagName.toLowerCase() === 'details') {
            const parent = current.parentElement;
            const siblings = parent.querySelectorAll(':scope > details');
            const i = Array.from(siblings).indexOf(current);
            openPath.unshift(i);
          }
          current = current.parentElement;
        }
        localStorage.setItem('openDetailsPath', openPath.join('>'));
      }, 100);
    });
  });

  // Highlight last clicked link
  ...
  if (lastScroll) {
    window.scrollTo(0, parseFloat(lastScroll));
  }
    <script>
        ...
        // Add color swatch interaction
        document.querySelectorAll('.color-swatch').forEach(swatch => {
            swatch.addEventListener('click', function() {
                document.documentElement.style.setProperty('--secondary-color', this.style.backgroundColor);
            });
        });
    </script>
  ...
  <div class='widget-content'>
    <data:content/>
        ...
        <b:widget id='HTML6' locked='false' title='Menu' type='HTML' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<!doctype html>
...
<script>
  ...
  // Restore last opened path from localStorage
  const lastOpenPath = localStorage.getItem('openDetailsPath');
  if (lastOpenPath) {
    const path = lastOpenPath.split('>');
    let current = document.querySelector('nav');
  ...
  <div class='widget-content'>
    <data:content/>
        ...
        <b:widget id='HTML11' locked='false' title='menu' type='HTML' visible='false'>
          <b:widget-settings>
            <b:widget-setting name='content'><![CDATA[<!doctype html>
    ...
    <div class="menu-bar">
        <button class="menu-button" onclick="closeAllDetails()">
            <i class="fas fa-chevron-circle-down"></i>
            Close All Sections
        </button>

        <details id="userSettings">
            <summary>
            ...
            <div class="content">
                <div class="settings-item">
                    ...
                    Privacy Settings
                    <button class="menu-button" style="margin-left: auto; padding: 4px 12px;">
                        Edit
                    </button>
                </div>
                <div class="settings-item">
                    ...
                    <select class="menu-button" style="margin-left: auto; padding: 4px;">
                        <option />English
                        <option />Español
                        <option />Français
                    </select>
